...
static const excel_font_mapping_t excel_font_mapping[] = {
    {"lv_font_fangsong_16", "中文", "zh_cn", LANG_ZH_CN},        // 简体中文
    {"lv_font_fangsong_16", "繁體中文", "zh_hk", LANG_ZH_HK},     // 繁体中文
    {"lv_font_timesnewromanpsmt_16", "English", "en", LANG_ENGLISH}, // 英语
    {"lv_font_timesnewromanpsmt_16", "Русский язык", "ru", LANG_RU}, // 俄语
    {"lv_font_segoeui_16", "اللغة العربية", "ar_ae", LANG_AR},   // 阿拉伯语
    {"lv_font_leelawadeeui_16", "ภาษาไทย", "th", LANG_TH},       // 泰语
    {"lv_font_segoeui_16", "Deutsch", "de", LANG_DE},            // 德语
    {"lv_font_segoeui_16", "Français", "fr", LANG_FR},           // 法语
    {"lv_font_malgungothic_16", "한국어", "ko", LANG_KO},         // 韩语
    {"lv_font_fangsong_16", "日本語", "ja", LANG_JA},             // 日语
    {"lv_font_segoeui_16", "Español", "es", LANG_ES},            // 西班牙语
    {"lv_font_segoeui_16", "Português", "pt", LANG_PT},          // 葡萄牙语
    {"lv_font_segoeui_16", "Čeština", "cs", LANG_CS},            // 捷克语
    {"lv_font_segoeui_16", "Polski", "pl", LANG_PL},             // 波兰语
    {"lv_font_segoeui_16", "Italiano", "it", LANG_IT},           // 意大利语
    {"lv_font_segoeui_16", "Nederlands", "nl", LANG_NL},         // 荷兰语
    {"lv_font_segoeui_16", "Svenska", "sv", LANG_SV},            // 瑞典语
    {"lv_font_segoeui_16", "Dansk", "da", LANG_DA},              // 丹麦语
