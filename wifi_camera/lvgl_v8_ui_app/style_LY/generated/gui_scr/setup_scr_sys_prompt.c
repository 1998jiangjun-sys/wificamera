...
lv_obj_t * setup_scr_sys_prompt(lv_ui *ui)
{
	...
	lv_obj_set_size(ui_scr->sys_prompt, 480, 640);
	...
	lv_obj_set_style_border_opa(ui_scr->sys_prompt, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui_scr->sys_prompt_img_warn, 44, 197);
	...
	lv_obj_set_style_outline_opa(ui_scr->sys_prompt_img_warn, 128, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write codes sys_prompt_lbl_warn
	ui_scr->sys_prompt_lbl_warn = lv_label_create(ui_scr->sys_prompt);
	lv_label_set_text(ui_scr->sys_prompt_lbl_warn, "No SD card");
	lv_label_set_long_mode(ui_scr->sys_prompt_lbl_warn, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui_scr->sys_prompt_lbl_warn, 97, 273);
	...
	lv_obj_set_style_shadow_opa(ui_scr->sys_prompt_lbl_warn, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_opa(ui_scr->sys_prompt_lbl_warn, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui_scr->sys_prompt_lbl_warn, lv_color_make(0xFF, 0xFF, 0xFF), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui_scr->sys_prompt_lbl_warn, &lv_font_arialmt_38, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_outline_opa(ui_scr->sys_prompt_img_2, 128, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_outline_opa(ui_scr->sys_prompt_img_1, 128, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_shadow_opa(ui_scr->sys_prompt_lbl_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_opa(ui_scr->sys_prompt_lbl_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_outline_opa(ui_scr->sys_prompt_lbl_1, 128, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui_scr->sys_prompt_lbl_1, &lv_font_FangZhengKaiTiJianTi_1_48, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui_scr->sys_prompt_lbl_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
